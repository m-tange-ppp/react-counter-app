export default function Setting(props) {
    return (
        <div className={"flex flex-col items-center justify-center gap-4 p-2 w-[100%] sm:w-[calc(50%-0.25rem)] border-neutral-900 rounded-xl bg-gradient-to-r from-blue-600 to-red-600"}>
